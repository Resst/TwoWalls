...
public class Level4 extends Level {
    ...
    //two moving triangles with small static between them
    void mvTSurprise(boolean onRightWall){
        creator.movingTriangle(onRightWall);
        creator.space(-Obstacle.standardSize / 2);
        creator.staticTriangle(onRightWall).translate(onRightWall ? Obstacle.standardSize * .75f : -Obstacle.standardSize * .75f, 0);
        creator.space(-Obstacle.standardSize / 2);
        creator.movingTriangle(onRightWall);
    }
